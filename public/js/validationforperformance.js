...
function startQuery(){
	...
	instream = fs.createReadStream('./validationtest.txt'),
...
module.exports.validate = function(request,res){
    ...
    Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        console.error('Failed to query successfully in validate :: ' + err);
    });
}
...
module.exports.transact = function(request,res){
	...
	var starttransaction = request["startTime"];
	var sender = request["sender"];
	var reciverUser = request["reciverUser"];
	var money = request["money"];
        ...
        if(results && results[1] && results[1].event_status === 'VALID') {
            console.log('Successfully committed the change to the ledger by the peer');
						responseChat={
						 ...
						 console.log("Hits in the else of transact");
						 ...
						 console.log("Checking transaction Execution time");
						 var timeval=endbalance - starttransaction;

						 var final = "sender "+sender+ " reciever "+reciverUser+" start time:"+starttransaction+" End time:"+endbalance+" time:"+ timeval+'ms\n';
						 i=i+1;
						 fs.appendFile('./validationwrite.txt',final, function (err) {
							 if (err) {
...
module.exports.check = function(request,res){
    ...
    Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        console.error('Failed to query successfully in check :: ' + err);
    });
}
